...
class AdminActionService
{
    ...
    private function approveCampaign(int $campaignId): array
    {
        ...
        $newStatus = 'approved'; // Default for future campaigns
        if ($startDate && $startDate <= $today) {
            $newStatus = 'active'; // Ready for immediate matching
        }
        ...
        // Only try to auto-match if status is 'active' (ready for matching)
