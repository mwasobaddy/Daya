...
- **Clients** pay for verified scans/leads generated by DCDs
- **Digital Ambassadors (DAs)** recruit and onboard new DCDs, earning 5% commissions
- **Digital Content Distributors (DCDs)** distribute QR codes to earn income and venture shares
...
### 💰 Earnings & Rewards
- **Commission Structure**: DAs earn 5% of recruited DCD earnings
...
**Rewards**:
- 5% commission on all recruited DCD earnings
